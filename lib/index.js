        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return Promise.all(_lotus.packages.map( /*#__PURE__*/function () {
              var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(pPath) {
                var packageObjTemp, packageObj, pName, preload, _packageObj$intents, intents, _packageObj$partials, partials, module, commandSize, eventSize, _i, _Object$entries, _Object$entries$_i, name, fn, _i2, _Object$entries2, _Object$entries2$_i, _name, command, newCommand, _i3, _Object$entries3, _Object$entries3$_i, _name2, value, _i4, _Object$entries4, _Object$entries4$_i, _name3, _value, loadedText;
                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 12:
                        ...
                        for (_i2 = 0, _Object$entries2 = Object.entries(packageObj.commands || {}); _i2 < _Object$entries2.length; _i2++) {
                          ...
                          newCommand = _objectSpread(_objectSpread({}, command), {}, {
                            moduleName: pName,
                            name: _name,
                            enabled: {}
                          });
                          commands.set(_name, newCommand);
                      ...
                      case 23:
                        ...
                        console.log("Failed to load ".concat(pName, " with error:"));
          ...
          case 3:
            ...
            _loop = function _loop() {
              ...
              client.on(eventName, function () {
                ...
                return events.forEach(function (item) {
                  try {
                    item.apply(void 0, [globals].concat(args));
                  } catch (err) {
                    console.log(err);
                  }
                });
            ...
            client.once('ready', function () {
              console.log("Discord bot started! Logged in as ".concat(client.user.tag));
            });
